...
class SpiDev:
    ...
    def open(self, bus, device):
        ...
        logging.debug(f"Mock SpiDev: Opening SPI bus {bus}, device {device}")
        pass
    ...
    def xfer2(self, data):
        ...
        """
        # logging.debug(f"Mock SpiDev: Transferring {len(data)} bytes")
        return [0] * len(data)

    def close(self):
        """Mocks closing the SPI bus. Does nothing."""
        logging.debug("Mock SpiDev: Closing SPI bus")
        pass
